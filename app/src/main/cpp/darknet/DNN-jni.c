...
JNIEXPORT jfloatArray JNICALL Java_com_example_hellojni_HelloJni_DnnEngineJNI( JNIEnv* env, jobject thiz , jobjectArray jargv)
{
#if defined(__arm__)
...
JNIEXPORT jstring JNICALL Java_com_example_hellojni_HelloJni_DnnEngineClassJNI( JNIEnv* env, jobject thiz , jobjectArray jargv)
{
#if defined(__arm__)
#if defined(__ARM_ARCH_7A__)
#if defined(__ARM_NEON__)
